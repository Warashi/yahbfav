...
var Assets = assets.NewFileSystem(map[string][]string{"/": []string{"index.html", "template.html"}}, map[string]*assets.File{
	"/": &assets.File{
		Path:     "/",
		FileMode: 0x800001ed,
		Mtime:    time.Unix(1515210553, 1515210553790217355),
		Data:     nil,
		...
		Path:     "/template.html",
		FileMode: 0x1a4,
		Mtime:    time.Unix(1515210553, 1515210553752587113),
